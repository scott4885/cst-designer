/**
 * Dump every AM slot for CDT OP5 and OP1 Monday to understand the shape.
 */
...
import { toMinutes, buildProviderSlotMap, getProviderOpSlots, getLunchMidpoint } from '../src/lib/engine/slot-helpers';
...
const result = generateSchedule({
  providers, blockTypes, rules: office.rules!, timeIncrement: office.timeIncrement,
  dayOfWeek: 'MONDAY', seed,
});
